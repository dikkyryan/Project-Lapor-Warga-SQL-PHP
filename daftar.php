...
<body>
  ...
  <section class="container">
      <section class="login-form">
        <form method="post" action="prosesdaftar.php" role="login">
          ...
          <div class="form-group">
          <input class="form-check-input" type="radio"  name="jk" id="option1" value="L" autocomplete="on"> Laki-Laki /
          ...
          <input type="text" name="alamat" placeholder="Jl.Contoh No.1" maxlength="30" required class="form-control input-lg" />
          <div class="form-group row" style="margin-bottom: 0px;">
          <div class="col-xs-6">
          <input type="text" name="rt" placeholder="RT" maxlength="3" required class="form-control input-lg" />
          </div>
          <div class="col-xs-6">
          <input type="text" name="rw" placeholder="RW" maxlength="3" required class="form-control input-lg" />
          </div>
          </div>
          <div class="form-group row" style="margin-bottom: 0px;">
          <div class="col-xs-6">
