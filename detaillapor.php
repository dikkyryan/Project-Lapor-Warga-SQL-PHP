                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p style="text-align:right;">
                            <a href="index.php" class="btn btn-default" role="button">&laquo; Kembali</a>
                        </p>
                ...
                ?>
                  <h3><?php echo $r['judul_laporan'];?></h3>
                    <div class="info-meta">
                        ...
                        <?php 
                        if($r['status_laporan']=='lapor'){
                        ?>
                        <ul class="list-inline"><li>Status Laporan : <span class="label label-info" style="text-transform: capitalize;">Terkirim</span></li></ul>
                        <?php }
                        else if ($r['status_laporan']=='periksa') {
                        ?>
                        <ul class="list-inline"><li>Status Laporan : <span class="label label-warning" style="text-transform: capitalize;">Sedang Diproses</span></li></ul>
                        <?php }
                        else if ($r['status_laporan']=='valid') {
                        ?>
                        <ul class="list-inline"><li>Status Laporan : <span class="label label-success" style="text-transform: capitalize;">Terverifikasi</span></li></ul>
                        <?php }
                        else if ($r['status_laporan']=='tidak valid') {
                        ?>
                        <ul class="list-inline"><li>Status Laporan : <span class="label label-danger" style="text-transform: capitalize;">Tidak Valid</span></li></ul>
                        <?php }
                        else if ($r['status_laporan']=='tindaklanjut') {
                        ?>
                        <ul class="list-inline"><li>Status Laporan : <span class="label label-warning" style="text-transform: capitalize;">Proses Tindaklanjut</span></li></ul>
                        <?php }
                        else if ($r['status_laporan']=='selesai') {
                        ?>
                        <ul class="list-inline"><li>Status Laporan : <span class="label label-primary" style="text-transform: capitalize;">Selesai</span></li></ul>
                        <?php }
                        ?>
                    </div>
                    <hr>
                    <div class = "media">
                       ...
                       ?>
                        ...
                        <p style="text-align:right;">
                            <a class="btn btn-success" data-toggle="modal" href="#myModal" role="button">Lihat Lokasi</a>
                            <a href="selesai.php" class="btn btn-primary" role="button">Selesai</a>
                        </p>
                        ...
                        <p style="text-align:right;">
                            <a class="btn btn-success" data-toggle="modal" href="#myModal" role="button">Lihat Lokasi</a>
                            <a href="prosesperiksa.php?id=<?php echo $r['id_laporan'];?>" class="btn btn-warning" role="button">Periksa</a>
                            <a href="prosestindak.php?id=<?php echo $r['id_laporan'];?>" class="btn btn-primary" role="button">Kirim ke Lembaga Terkait</a>
                        </p>
                    <?php } ?>
                </div>
                </div>
