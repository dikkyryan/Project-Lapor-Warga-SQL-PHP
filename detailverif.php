                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p style="text-align:right;">
                            <a href="laporanverif.php" class="btn btn-default" role="button">&laquo; Kembali</a>
                        </p>
                    ...
                    <div class = "media">
                       ...
                       ?>
                        ...
                        <p style="text-align:right;">
                            ...
                            <a href="prosestindak.php?id=<?php echo $r['id_laporan'];?>" class="btn btn-warning" role="button">Kirim ke Lembaga Terkait</a>
