                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p style="text-align:right;">
                            <a href="periksalaporan.php" class="btn btn-default" role="button">&laquo; Kembali</a>
                        </p>
                    ...
                    <div class = "media">
                       ...
                       ?>
                        ...
                        <p style="text-align:right;">
                            ...
                            <a href="prosesnovalid.php?id=<?php echo $r['id_laporan'];?>" class="btn btn-danger" role="button">Tidak Valid</a>
                            <a href="prosesvalid.php?id=<?php echo $r['id_laporan'];?>" class="btn btn-primary" role="button">Valid</a>
                        </p>
